      ...
      <div class="vc-parent">
        <div class="vc-child">
          <div class="top-banner">
            <div class="container">
              <img class="svg custom-element-right" src="{$WEB_ROOT}/templates/{$template}/assets/patterns/rack.svg" alt="Dedicated Server">
        ...
        <div class="vc-child">
          <div class="top-banner">
            <div class="container">
              ...
              <img class="svg custom-element-right" src="{$WEB_ROOT}/templates/{$template}/assets/patterns/domains.svg" alt="Domains">
                ...
                <form method="post" action="domainchecker.php" id="frmDomainHomepage">
                  ...
                  <div class="col-xs-12 col-sm-6 col-md-6">
                    <div class="pull-left">
                        ...
                        <input type="submit" id="btnTransfer" class="btn btn-default-fill transfer{$captcha->getButtonClass($captchaForm)}" value="{$LANG.domainstransfer}" />
                        {/if}
                    </div>
                  </div>
                </form>
    ...
    <div class="full h-100">
      ...
      <div class="vc-parent">
        <div class="vc-child">
          <div class="top-banner">
            <div class="container">
              <img class="svg custom-element-right" src="{$WEB_ROOT}/templates/{$template}/assets/patterns/cloudvps.svg" alt="Cloud VPS Server">
        ...
        <div class="col-sm-12 col-md-4 col-lg-4">
          <div class="wrapper first text-left">
            <div class="top-content">
              ...
              <div class="price"><sup>$</sup>8.19 USD <span class="period">Monthly</span></div>
              <a href="{$WEB_ROOT}/cart.php?gid=1" class="btn btn-default-yellow-fill">All plans</a>
            </div>
            <ul class="list-info">
        ...
        <div class="col-sm-12 col-md-4 col-lg-4">
          <div class="wrapper third text-left">
            <div class="top-content">
              ...
              <div class="fromer">Starting at:</div>
              <div class="price"><sup>$</sup>9.99 USD <span class="period">Monthly</span></div>
              <a href="{$WEB_ROOT}/cart.php?gid=2" class="btn btn-default-yellow-fill">All plans</a>
            </div>
            <ul class="list-info">
...
<script src="{$WEB_ROOT}/templates/{$template}/assets/js/covervid.min.js?v={$versionHash}"></script>
...
<section id="main-body">
    <div class="container{if $skipMainBodyContainer}-fluid without-padding{/if}">
      ...
      <div class="{if !$inShoppingCart && ($primarySidebar->hasChildren() || $secondarySidebar->hasChildren())}col-md-9 pull-md-right{else}col-md-12{/if} main-content">
